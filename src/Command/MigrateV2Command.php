...
final class MigrateV2Command extends Command
{
    ...
    private function validationSchema(): array
    {
        ...
        $tables = [
            ...
            'validation_issue' => "CREATE TABLE validation_issue (id INT AUTO_INCREMENT NOT NULL, semestre_id INT DEFAULT NULL, scope_type VARCHAR(255) NOT NULL, scope_id INT NOT NULL, rule_code VARCHAR(255) NOT NULL, severity VARCHAR(15) NOT NULL, message LONGTEXT DEFAULT NULL, payload JSON DEFAULT NULL, type_diplome VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', INDEX IDX_VALIDATION_SEMESTRE (semestre_id), PRIMARY KEY(id), CONSTRAINT FK_VALIDATION_SEMESTRE FOREIGN KEY (semestre_id) REFERENCES semestre (id) ON DELETE CASCADE) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB",
        ];
    ...
    private function check(SymfonyStyle $io): int
    {
        ...
        foreach (['fiche_matiere_tab_state', 'formation_tab_state', 'parcours_tab_state', 'validation_issue'] as $table) {
            if (!$this->tableExists($table)) {
