...
final class MigrateV2CleanupCommand extends Command
{
    ...
    private function migrationCompleted(): bool
    {
        ...
        $required = ['010_documented_schema', '020_validation_schema', '030_admission_years', '040_new_v2_tables', '090_reconcile_schema', '100_safe_defaults', '110_finalize_constraints'];
